...
Router.route('category/:category/:subcategory?', {
  name: 'category',
...
Router.route('account', {
  ...
  //   if(user) {
  //     SEO.set({
  //       title: (user.profile.name || "My Account") + " | ChangeUp",
  //     });
  //   } else {
  //     this.redirect('/login');
  //   }
...
Router.route('vendors/:vendorId', {
  ...
  //   if(vendor){
  //     SEO.set({
  //       title: vendor.storeName + " | ChangeUp",
  //       meta: {
  //         'description': vendor.storeDescription
  //       },
  //       og: {
  //         'type': 'article',
  //         'article:author': "ChangeUp",
  //         'title': vendor.storeName+ " | ChangeUp",
  //         'description': vendor.storeDescription,
  //       }
  //     });
